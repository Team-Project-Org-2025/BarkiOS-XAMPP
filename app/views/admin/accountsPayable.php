...
<div class="main-content">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="display-6 fw-bold text-dark">Cuentas por Pagar</h1>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addAccountModalLabel">Nueva Cuenta por Pagar</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 search-loading">
                        ...
                        <input  type="text" 
                                ...
                                autocomplete="off"
                                data-min-chars="2">
                        <input type="hidden" id="proveedorId" name="proveedor_id" required>
                        <div id="supplierResults" class="list-group mt-1 position-absolute w-100" style="z-index: 1050;"></div>
...
<script src="/BarkiOS/public/assets/js/accountsPayable.js"></script>
</body>
</html>