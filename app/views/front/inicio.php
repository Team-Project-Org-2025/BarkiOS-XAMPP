    ...
    <main>
        ...
        <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="hero-slide d-flex align-items-center" style="background-image: url('/public/assets/images/tienda6.jpeg');">
                        <div class="container">
                            <div class="carousel-caption text-start">
                                ...
                                <a href="/productos" class="btn btn-lg btn-dark" data-aos="fade-up" data-aos-delay="400">Explorar Colección</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="hero-slide d-flex align-items-center" style="background-image: url('/public/assets/images/tienda1.jpeg');">
                        <div class="container">
                            <div class="carousel-caption">
                                ...
                                <a href="/novedades" class="btn btn-lg btn-dark">Ver Novedades</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="hero-slide d-flex align-items-center" style="background-image: url('/public/assets/images/tienda2.jpeg');">
                        <div class="container">
                            <div class="carousel-caption text-end">
                                ...
                                <a href="/nosotros" class="btn btn-lg btn-dark">Conócenos</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-5">
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-md-4" data-aos="fade-up">
                        <a href="/productos?categoria=Formal" class="category-card">
                    ...
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                        <a href="/productos?categoria=Casual" class="category-card">
                            <div class="category-image">
                    ...
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="400">
                        <a href="/productos?categoria=Deportivo" class="category-card">
                            <div class="category-image">
                ...
                <div class="text-center mt-5">
                    <a href="/productos" class="btn btn-outline-dark btn-lg">Ver Todas las Categorías</a>
                </div>
            </div>
        </section>
        ...
        <section class="py-5 bg-light">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-5">
                    ...
                    <a href="/productos" class="btn btn-link text-dark text-decoration-none" data-aos="fade-left">Ver Todas <i class="fas fa-arrow-right ms-2"></i></a>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-4 mb-lg-0" data-aos="fade-right">
                        <img src="/public/assets/images/tienda3.webp" class="img-fluid rounded" alt="Sobre Nosotros">
                    </div>
                    <div class="col-lg-6" data-aos="fade-left">
                        ...
                        <a href="/nosotros" class="btn btn-outline-dark mt-3">Conoce Nuestra Historia</a>
                    </div>
                </div>
            </div>
        </section>
...
<?php require_once __DIR__ . '/../partials/footer.php';?>
    ...
    <!-- Controller Scripts -->
    <script src="/public/assets/js/front/main.js"></script>
</body>
</html>